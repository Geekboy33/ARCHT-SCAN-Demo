        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
          <div className="mb-8">
            <span className="inline-block bg-cyan-900/30 text-cyan-400 px-4 py-2 rounded-full text-sm font-medium border border-cyan-400/30">
              Asset Explorer • {allAssets.length} Assets
            </span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
            Discover and explore all tokenized real-world assets across multiple categories and regions
          </p>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-white font-medium">${asset.currentPrice?.toFixed(2) || asset.price?.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between text-sm">
